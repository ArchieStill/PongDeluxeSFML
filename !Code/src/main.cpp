...
int main()
{
  ...
  // create window and set up_key
  sf::RenderWindow window(sf::VideoMode(1080, 720), "PONG DELUXE");
  ...
  while (window.isOpen())
  {
    ...
    while (window.pollEvent(event))
    {
      ...
      // initialises Enter as a key that can be pressed to perform an action
